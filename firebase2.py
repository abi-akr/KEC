...
if __name__ == "__main__":
    ...
    The above code running finely without any issues as expected but i need to add only one additional feature of adding the marks and submission history of student and that is the remaining work have to be done yet and also please let me know if any changes have to be done 
